        ...
        <div id="wrapper">
            ...
            >
                ...
                <li class="nav-item active">
                    <router-link class="nav-link" to="/berandaadmin">
                ...
                <li class="nav-item active">
                    <router-link class="nav-link" to="/postinganadmin">
                        <i class="fas fa-fw fa-tachometer-alt"></i>
                        <span>Postingan</span></router-link
                    >
                    <!-- <a class="nav-link" href="index.html">
                        <i class="fas fa-fw fa-tachometer-alt"></i>
                        <span>Dashboard</span></a
                ...
                <li class="nav-item active">
                    <router-link class="nav-link" to="/komentaradmin">
                        <i class="fas fa-fw fa-tachometer-alt"></i>
